...
export function DisplayBookedRoom() {
  ...
  useEffect(() => {
    async function fetchRoom() {
      try {
        const res = await fetch("/api/Booking"); // use relative path
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          ...
                          <span className="text-xs text-muted-foreground">Bed: {r.bed}</span>
                    ...
                    <div className="mt-4 text-sm text-muted-foreground">
                      <p className="line-clamp-2">
                        This room is currently booked. You can checkout to free the room and record
                        checkout time.
                      </p>
                    </div>
                  </div>
